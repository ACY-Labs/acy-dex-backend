function createGeometry() {
  ...
  nodeRegular = THREE.ImageUtils.loadTexture(
  ...
  nodeThreat = THREE.ImageUtils.loadTexture(
  ...
  var nodePositions = new THREE.BufferAttribute(
    new Float32Array(nodesCount * 3),
    3
  );
  var nodeReferences = new THREE.BufferAttribute(
    new Float32Array(nodesCount * 2),
    2
  );
  var nodeColors = new THREE.BufferAttribute(
    new Float32Array(nodesCount * 3),
    3
  );
  ...
  $.each(g.nodes, function (key, value) {
    ...
    $.each(value.data, function (dkey, dvalue) {
      if (key == "ETH" || key == "BTC") threatValue = 1;
    });
  ...
  var edgePositions = new THREE.BufferAttribute(
    new Float32Array(edgesCount * 2 * 3),
    3
  );
  var edgeReferences = new THREE.BufferAttribute(
    new Float32Array(edgesCount * 2 * 2),
    2
  );
  var edgeColors = new THREE.BufferAttribute(
    new Float32Array(edgesCount * 2 * 3),
    3
  );
