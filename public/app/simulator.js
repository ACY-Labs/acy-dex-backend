function Simulator(renderer) {
  ...
  function init() {
    ...
    velocityShader.uniforms.layoutPositions.value = generateCircularLayout(
      nodesAndEdges,
      nodesWidth
    );
    ...
    nodeAttribShader.uniforms.edgeIndices.value =
      velocityShader.uniforms.edgeIndices.value;
    nodeAttribShader.uniforms.edgeData.value =
      velocityShader.uniforms.edgeData.value;
  ...
  this.renderNodeAttrib = function (
    nodeAttrib,
    output,
    epochMin,
    epochMax,
